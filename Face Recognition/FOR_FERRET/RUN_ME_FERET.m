...
%======================Acquire test images Randomly=======================%    
   ...
   face=imread(strcat('C:\Users\Tilak\Documents\MATLAB\Our_Face Recognition\FOR_FERRET\Color FERET Custom\s',...
...
for n=1:tests                       
    ...
    img = imread(strcat('C:\Users\Tilak\Documents\MATLAB\Our_Face Recognition\FOR_FERRET\Color FERET Custom\s',...
